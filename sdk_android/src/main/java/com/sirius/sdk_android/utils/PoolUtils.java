...
public class PoolUtils {
    ...
    private static final String DEFAULT_POOL_NAME = "_default_pool";
    public static final int PROTOCOL_VERSION = 2;


    private static File createGenesisTxnFile(String path) throws IOException {
    ...
    public static String createPoolLedgerConfig(String name,String path) throws IOException, InterruptedException, java.util.concurrent.ExecutionException, IndyException {
        //File genesisTxnFile = new File(path);
        File genesisTxnFile = createGenesisTxnFile(path);
